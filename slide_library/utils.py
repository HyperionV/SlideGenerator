...
def normalize_presentation(pptx_path: str) -> Tuple[Presentation, PresentationMapping]:
    ...
    Check slide notes and use them as description if available.
    ...
    for slide_idx, slide in enumerate(presentation.slides, 1):
        ...
        # Check for slide notes and use as description if available
        slide_notes = extract_slide_notes(slide)
        slide_description = slide_notes if slide_notes else ""

        slide_content = SlideContent(slide=slide_idx, metadata=slide_metadata, content={}, description=slide_description)
